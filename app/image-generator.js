    ...
    return new Promise((resolve, reject) => {
        ...
        worker.postMessage({
            ...
            options: {
                ...
                model: options.model || config.model || 'turbo',
                negativePrompt: options.negativePrompt || config.defaultNegativePrompt,
                fallbackEndpointTemplate: options.fallbackEndpointTemplate || config.fallbackEndpointTemplate
            }
        });
    });
}
