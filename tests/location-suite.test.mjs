...
assert.ok(htmlCard.includes('Exact Pin:'));
assert.ok(htmlCard.includes('Open in Google Maps'));
assert.ok(htmlCard.includes('Get Directions'));
console.log('  [PASS] 4.1 Streamlined dynamic location suite HTML rendered with AI summary, weather, area table, and OpenStreetMap pin');
