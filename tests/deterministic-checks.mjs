...
assert.match(SOURCE.appHtml, /id="context-topic-chip-host"/);
assert.match(SOURCE.appHtml, /function updateContextTopicChip/);
...
assert.match(fs.readFileSync(new URL('../app/context-copilot-ui.js', import.meta.url), 'utf8'), /buildActiveTopicChipHtml/);
...
assert.match(SOURCE.styles, /\.context-topic-chip\s*\{/);
