...
// ============================================================================
// Test 8: Verified Groq Candidate Model Hierarchy
// ============================================================================
console.log('\n--- Test 8: Verified Groq Candidate Model Hierarchy ---');
{
    const candidates = getPreferredGroqCandidates('', { userSelectedModel: null });
    assert.equal(candidates[0], 'llama-3.3-70b-versatile', 'Top candidate must be active production model llama-3.3-70b-versatile');
    assert.equal(candidates[1], 'llama-3.1-8b-instant', 'Second candidate must be llama-3.1-8b-instant');
    console.log('  [PASS] 8.1 Active production models prioritized first: ' + candidates.slice(0, 3).join(', '));
}

console.log('\n================================================================');
console.log('=== All Phase 10 VTT Assistant Bugfix Verification Tests Passed! ===');
console.log('================================================================\n');
