...
It is local, deterministic, private, and free-for-life. Models still generate answers; the follow-up decision stays in the app.
...
- `NVIDIA_API_KEY` / `NVIDIA_NIM_API_KEY`, `NVIDIA_EMBEDDING_MODEL`
