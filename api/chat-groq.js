...
import { classifyImageLocally } from './_lib/local-vision-classifier.js';
    ...
    - Image Description Rule: When an image is attached and the user asks about it (for example "What is this?", "Describe this", "Who is this?", "What do you see?"):
      ...
      2. PERSON & PORTRAIT RECOGNITION: When a person appears in the image, first attempt to recognize and name them if they are a well-known public figure, celebrity, historical figure, or famous individual with high confidence based on clear visible features. If they are not a known public figure or you cannot identify them with confidence, NEVER guess or invent a name. Instead, always describe how the person looks (apparent age, facial features, hair, expression), what they are wearing (clothing style, colors, patterns, accessories), what they are doing (action, posture, gestures), and the setting/environment they are in.
