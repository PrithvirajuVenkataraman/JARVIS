...
import { classifyImageLocally } from './_lib/local-vision-classifier.js';
    ...
    - Image Description Rule: When an image is attached and the user asks about it (for example "What is this?", "Describe this", "What do you see?"), describe what is shown in the image directly. NEVER state "I cannot see the image", "without direct access to the image", or write meta-commentary about vision algorithms, machine learning, CNNs, or OCR. State the visual details, text, objects, and scene depicted in the image directly.
